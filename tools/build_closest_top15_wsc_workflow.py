#!/usr/bin/env python3
"""Build a CLOSEST-based workflow export for Top 15 GRS + WSC."""
...
DEFAULT_OUTPUT = ROOT / "workflow_exports" / "weekly-supplier-report-closest-top15-wsc.json"
SQL_PATH = ROOT / "workflow_assets" / "closest_top15_wsc.sql"
FORMATTER_PATH = ROOT / "workflow_assets" / "email_formatter_closest_top15_wsc.js"
SALES_BUCKETS_PATH = ROOT / "workflow_assets" / "sales_buckets_top15.js"
...
def build_workflow(input_path: Path) -> dict:
    ...
    nodes["Sales Buckets"]["parameters"]["jsCode"] = load_text(SALES_BUCKETS_PATH)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a CLOSEST-based workflow export with Top 15 GRS, WSC, and pricing WoW metrics."
    )
