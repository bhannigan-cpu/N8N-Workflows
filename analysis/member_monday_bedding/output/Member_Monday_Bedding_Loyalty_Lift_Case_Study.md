...
**Data QA note:** The headline uses the full Bedding event total from the source file: $97,551.63 baseline sales and $124,455.00 Member Monday sales. The class, supplier, and discount-bucket summaries use the post-cleanup visible SKU-detail rows, which sum to $97,553.26 baseline sales and $120,149.08 Member Monday sales.
